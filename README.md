...
```javascript
import { Bernoulli, cdf, entropy, kurtosis, mean, median, mgf, mode, pmf, quantile, skewness, stdev, variance } from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dists-bernoulli@v0.2.0-deno/mod.js';
```
